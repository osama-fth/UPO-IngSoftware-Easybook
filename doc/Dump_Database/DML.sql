-- 1. BIBLIOTECARI
INSERT INTO Bibliotecario (matricola, nome, cognome, username, password) VALUES
('BIB001', 'Osama', 'Foutih', 'osama.foutih', 'osama123'),
('BIB002', 'Lorenzo', 'Bellotti', 'lorenzo.bellotti', 'lorenzo123'),
('BIB003', 'Riccardo', 'Negrini', 'riccardo.negrini', 'riccardo123');

-- 2. UTENTI
INSERT INTO Utente (cf, nome, cognome, stato, num_prestiti_attivi) VALUES
('RSSMRA80A01H501U', 'Mario', 'Rossi', 'ATTIVO', 1),
...
-- 3. LIBRI
INSERT INTO Libro (isbn, titolo, autore, copie_totali, copie_disponibili) VALUES
('9788804668237', '1984', 'George Orwell', 5, 3),            
...
-- 4. PRESTITI
INSERT INTO Prestito (id, utente_cf, libro_isbn, data_inizio, data_scadenza, data_restituzione) VALUES
(1, 'RSSMRA80A01H501U', '9788806218034', '2025-09-01', '2025-10-01', '2025-09-28'),
...
-- 5. SANZIONI
INSERT INTO Sanzione (id, prestito_id, importo, pagata) VALUES
(1, 3, 13.50, 0),
(2, 4, 10.00, 1),
(3, 5, 11.00, 1);
